...
export default function Scene({}: Props) {
    ...
    useGSAP(() => {
        ...
        .to(can2Ref.current.position,  { x: 1, y: -0.2, z: -1 }, 0) //2
        .to(can2Ref.current.rotation, {z: 0}, 0)
        .to(can3Ref.current.position, { x: -0.3, y: 0.5, z: -1 }, 0) //3
        .to(can3Ref.current.rotation, { z: -0.1 }, 0)
        .to(can4Ref.current.position, { x: 0, y: -0.3, z: 0.5 }, 0) //4
        .to(can4Ref.current.rotation, { z: 0.3 }, 0)
        .to(can5Ref.current.position, { x: 0.3, y: 0.5, z: -0.5 }, 0) //5
